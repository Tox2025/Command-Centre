...
const SESSIONS = [
    ...
    { name: 'OPEN', start: 541, end: 600, intervalMs: 300000 }, // 9:01 – 10:00 AM, 5 min
    { name: 'MIDDAY', start: 601, end: 720, intervalMs: 600000 }, // 10:01 AM – 12:00 PM, 10 min
    { name: 'AFTERNOON', start: 721, end: 975, intervalMs: 600000 }, // 12:01 – 4:15 PM, 10 min (UW off)
    { name: 'AFTER_HOURS', start: 976, end: 1020, intervalMs: 600000 }, // 4:16 – 5:00 PM, 10 min (UW off)
];
...
class SessionScheduler {
    ...
    // Check if UW API should be active (off from 12 PM to 7:30 AM EST)
    isUWActive() {
        var mins = this.getESTMinutes(); // minutes from midnight
        // Active from 7:30 AM (450) to 12:00 PM (720)
        return mins >= 450 && mins < 720;
    }
